<template>
    ...
    <div class="pizzen">   
      <img  id="logo" alt="logo" src="../assets/pizzaanim.gif">

 
<div class="container">
  <div class="card" v-for="pizza in pizzen" :key="pizza.id">
    <div class="box" >
      <div class="content">
        ...
        <a href="#" @click="addToCart(pizza.preis,pizzen.name)">Bestellen</a>
      </div>
    </div>
  </div>
